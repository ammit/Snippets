...
jQuery(document).ready(function($) {
	...
	/**
	 *
	 * Check if page supports object-fit
	 *
	 */
	...
	if ($('html').hasClass('no-objectfit')) {
		...
		$( '.object-fit' ).each(function() {
			...
			/**
			*
			* Set background image style on parent div
			* Requirements:
			* 	- parent must use class defined above
			* 	- must have 'display: inline-block' applied, 
			* 	this is so that it can inherit the proportions of the img
			*
			*/
			...
			// *
			// *
			// * Hide what would be the stretched image 
			// *
